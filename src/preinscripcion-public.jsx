...
const PREGUNTAS = [
  ...
  },
  {
    ...
    type: 'chips',
    required: true,
    options: ['Sí, regularmente', 'A veces', 'Estoy empezando', 'No practico aún'],
  },
  {
    id: 'tiempo_practica',
    label: '¿Hace cuánto tiempo practicas?',
    type: 'chips',
    required: false,
  ...
  },
  {
    ...
    type: 'chips',
    required: true,
    options: ['Sí, profesionalmente', 'Sí, a amigos/familia', 'No, sería mi primera vez'],
  },
  {
    id: 'motivacion',
  ...
  {
    id: 'lesiones',
    label: 'Lesiones, condiciones médicas o restricciones físicas',
    type: 'textarea',
    required: false,
    placeholder: 'Ej. lesión de rodilla, embarazo, hernia... (déjalo en blanco si no aplica)',
  },
  {
    id: 'expectativas',
